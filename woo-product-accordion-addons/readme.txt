...
Selecting an add-on alone does not add anything to the cart. The selected add-ons are only added when the customer clicks the parent product's normal Add to Cart button. Each add-on is always added with a quantity of 1, independently of the parent product quantity.
