...
final class G2_WC_Product_Accordion_Addons {
	...
	public function enqueue_assets() {
		...
		wp_enqueue_style( 'g2-wc-product-accordion-addons', plugin_dir_url( __FILE__ ) . 'assets/css/frontend.css', array(), '1.7.2' );
		wp_enqueue_script( 'g2-wc-product-accordion-addons', plugin_dir_url( __FILE__ ) . 'assets/js/frontend.js', array(), '1.7.2', true );
	}
