...
final class G2_WC_Product_Accordion_Addons {
	...
	public function enqueue_assets() {
		...
		wp_register_style( 'g2-wc-product-accordion-addons', false, array(), '1.7.0' );
		wp_enqueue_style( 'g2-wc-product-accordion-addons' );
		wp_add_inline_style( 'g2-wc-product-accordion-addons', '.g2-wc-addon__quantity{width:64px;height:34px;margin-left:auto}' );
		wp_register_script( 'g2-wc-product-accordion-addons', false, array(), '1.7.0', true );
