...
final class G2_WC_Product_Accordion_Addons {
	...
	public function check_for_updates( $transient ) {
		...
		$current_version = isset( $transient->checked[ $plugin_file ] ) ? $transient->checked[ $plugin_file ] : '1.7.3';
	...
	public function enqueue_assets() {
		...
		wp_register_style( 'g2-wc-product-accordion-addons', false, array(), '1.7.3' );
		...
		wp_register_script( 'g2-wc-product-accordion-addons', false, array(), '1.7.3', true );
